...
{
    typedef db_SpecEventRound_ext_t spec_event_round_t;
    typedef boost::shared_ptr<spec_event_round_t> sp_spec_event_round_t;
    typedef unordered_map<int32_t,sp_spec_event_round_t> spec_event_round_hm_t;
public:
    /* event */
    sc_spec_event_t();
...
typedef boost::shared_ptr<sc_msg_def::jpk_spec_event_rank_t>
    sp_spec_event_rank_t;
class sc_spec_event_rank_t
{
public:
    /* rank */
